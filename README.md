...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Like Matsumoto and Ogawa<sup>[1](https://www.math.kyoto-u.ac.jp/~kaji/papers/SIGGRAPH2019_Polyvision_final.pdf)</sup>, we created a 3D representation of a 4D scene for the user to explore from the first person. However, in our implementation, the user can never see a different choice of axes in the same way they see along x, y, and z space. Instead, the bar at the bottom of the user's screen communicates to them where they are in w-space in a much more compact, if less abounding, manner. 
